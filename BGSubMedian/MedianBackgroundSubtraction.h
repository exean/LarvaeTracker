/**
 *  @file MedianBackgroundSubtractor.h
 *
 *  @section DESCRIPTION
 *  Generates a matrix of temporal median pixel values  
 ...
 *	and subtracts these from input images.
 */
class MedianBackgroundSubtraction
	: public Dll::ABackgroundSubtractor
{
public:
	MedianBackgroundSubtraction(void);
	~MedianBackgroundSubtraction(void);
...
extern "C"
{
    ...
    */
	...
	{
		return new MedianBackgroundSubtraction();
	}	
}
