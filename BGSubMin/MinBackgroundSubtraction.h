/**
 *  @file MinBackgroundSubtraction.h
 *
 *  @section DESCRIPTION
 *  Background subtraction using a matrix of temporal minimum pixel
 *	values and subtracts these from input images.
 */
...
/**
 *  Generates a matrix of temporal minimum pixel values
 *  and subtracts these from input images.
 */
class MinBackgroundSubtraction
	: public Dll::ABackgroundSubtractor
{
public:
	MinBackgroundSubtraction(void);
	~MinBackgroundSubtraction(void);
...
extern "C"
{
    ...
    */
	...
	{
		return new MinBackgroundSubtraction();
	}	
}
